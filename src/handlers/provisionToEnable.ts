...
export const createPool = async (event: SubstrateEvent) => {
	...
	pool.token0Amount = token0Amount;
	pool.token1Amount = token1Amount;
	pool.token0Price = BigInt(new FN(parseInt(token0Amount.toString()) / parseInt(token1Amount.toString()), 18).toChainData());
	pool.token1Price = BigInt(new FN(parseInt(token1Amount.toString()) / parseInt(token0Amount.toString()), 18).toChainData());
...
export const createHourPool = async (event: SubstrateEvent, token0Amount: bigint, token1Amount: bigint, price0: FN, price1: FN, decimals0: number, decimals1: number) => {
	...
	hourPool.token0Price = BigInt(new FN(parseInt(token0Amount.toString()) / parseInt(token1Amount.toString()), 18).toChainData());
	hourPool.token1Price = BigInt(new FN(parseInt(token1Amount.toString()) / parseInt(token0Amount.toString()), 18).toChainData());
...
export const createDailyPool = async (event: SubstrateEvent, token0Amount: bigint, token1Amount: bigint, price0: FN, price1: FN, decimals0: number, decimals1: number) => {
	...
	dailyPool.token0Price = BigInt(new FN(parseInt(token0Amount.toString()) / parseInt(token1Amount.toString()), 18).toChainData());
	dailyPool.token1Price = BigInt(new FN(parseInt(token1Amount.toString()) / parseInt(token0Amount.toString()), 18).toChainData());
